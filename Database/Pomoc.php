...
?>
    ...
    ?>
        <div class="info3">
            ...
            Пријавили сте испите који се налазе на овој страници. Уколико нисте пријавили све испите које можете, поред списка пријављених испита можете пријавити преостале испите које нисте.
        </div>
    <?php
    }
